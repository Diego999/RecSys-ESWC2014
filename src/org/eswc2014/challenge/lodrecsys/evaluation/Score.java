...
public class Score implements Comparable<Score> {
	 ...
	 * 
	 * @param userId
	 *            the identifier of the user associated to the score
	 * @param itemId
	 *            the identifier of the item associated to the score
	 * @param value
	 *            the score's numeric value
	 * 
	 * @throws IllegalArgumentException
	 *             in case of a null user/item identifier
	 */
	public Score(String userId, String itemId, double value)
			throws IllegalArgumentException {
		if (userId == null) {
	...
	public boolean equals(Object obj) {
		...
		if ((this.itemId == null) ? (other.itemId != null) : !this.itemId
				.equals(other.itemId)) {
			return false;
		}
		return true;
	...
	public String toString() {
		return "Score{" + "user=" + this.userId + ", item=" + this.itemId
				+ ", value=" + this.value + '}';
	}
	
	public static void main(String[] args) {
		Score s = new Score ("","",1.0);
		Score sa = new Score ("","",2.0);
