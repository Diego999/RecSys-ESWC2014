...
public class ILS implements Metric {
	 ...
	 * 
	 * @param itemMetadata
	 *            an object that stores the items' metadata
	 * @param itemSimilarity
	 *            an object that computes the (content-based) similarity between
	 *            two items
	 */
	public ILS(EvaluationItemMetadata itemMetadata,
			ItemSimilarity itemSimilarity) throws IllegalArgumentException {
	 ...
	 * 
	 * @param scores
	 *            test scores with which compute the ILS value
	 * 
	 * @throws Exception
